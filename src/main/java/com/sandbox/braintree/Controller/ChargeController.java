...
public class ChargeController {
    ...
    @ResponseBody
    public TransactionResponse charge(@Valid @RequestBody ChargeRequest chargeRequest, @RequestParam("cus_id") Integer customersId, @RequestParam("settlement") String settlement) {
